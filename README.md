...
- `assets/` — recruiter-facing SVG dashboard and architecture previews
...
This generates the 55,000-row fact table, all dimension CSVs, a formatted Excel data dictionary, and a validation summary under `generated/`.
